...
def gerar_pdf():
    ...
    final_df = lime2[lime2['Nome do Projeto'] == projeto]
    ...
    if lime2['Este projeto visa .... [Implantar nova(s) atividade(s) produtiva(s)]'][id_resposta] == 'Sim':
        ...
        c.drawString(
            162, 330, 'Fortalecer atividade(s) produtiva(s) pré-existente(s)')
